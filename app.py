...
with mysql.connector.connect(host="localhost",user="root",password="system",database="flaskblog"):
    ...
    cursor.execute("create table if not exists registration(username varchar(50) primary key,mobile varchar(60) unique,email varchar(70) unique,address varchar(80),password varchar(90))")
